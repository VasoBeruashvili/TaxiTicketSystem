    ...
    <html>
      ...
      <body style="padding: 5px 5px 20px 5px;">
        ...
        <span style="float: right; margin: 0 0 5px 0; padding: 2px 2px 5px 2px; border: 1px solid #777; font-size: 12px; border-top: none; background-color: #FFFF00;">
          თანხა დღგ-ს ჩათვლით: <xsl:value-of select="*/withVat" />
        </span>        
        <span style="float: right; margin: 0 15px 5px 0; padding: 2px 2px 5px 2px; border: 1px solid #777; font-size: 12px; border-top: none; background-color: #FFFF00;">
          დღგ: <xsl:value-of select="*/vat" />
        </span> 
        <span style="float: right; margin: 0 15px 5px 0; padding: 2px 2px 5px 2px; border: 1px solid #777; font-size: 12px; border-top: none; background-color: #FFFF00;">
          თანხა დღგ-ს გარეშე: <xsl:value-of select="*/withoutVat" />
        </span>
      </body>
    </html>
  </xsl:template>
