...
namespace TaxiTicketSystem.GenerationLogic.Excel
{
    ...
    {
        public byte[] GenerateExcel(XElement element, string xsltFileName)
        {
            XslCompiledTransform _transform = new XslCompiledTransform(false);
            _transform.Load(HttpContext.Current.Server.MapPath("~/App_Data") + "/Excel/" + xsltFileName);
        ...
        public string GetExcelTempFilePathWithExtension()
        {
